...
class SquareWave(SineWave):
    ...
    def __init__(self, pitch=0, pitch_per_second=12, decibels=0, decibels_per_second=1, channels=1, channel_side="lr",
        ...
        self.squarewave_generator = squarewave_generator.SquareWaveGenerator(
    ...
    def _callback(self, outdata, frames, time, status):
        ...
        data = self.squarewave_generator.next_data(frames)
